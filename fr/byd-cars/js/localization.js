...
String.toLocaleString({
    ...
    "%credits"              : "Images BYD",
    "%tweet1"               : "J'ai marqué \" at 2048-BYD-CARS #2048game",
    "%tile-legend"          : "<strong class=\"important\">Tuiles BYD :</strong>",
    '%2'                    : 'BYD Seagull',
    '%4'                    : 'BYD Dolphin',
    '%8'                    : 'BYD Yuan',
    '%16'                   : 'BYD Song',
...
"fr": {
    "%game-intro"           : "Fusionnez les BYD et créez votre <strong>voiture de rêve</strong> !",
    "%restart-button"       : "Nouvelle partie",
    "%keep-playing-button"  : "Continuer",
    "%retry-button"         : "Réessayer",
    "%game-won"             : "Victoire !",
    "%game-over"            : "Partie terminée !",
    "%game-explanation"     : "<strong class=\"important\">Comment jouer :</strong> Utilisez les <strong>flèches</strong> pour déplacer les tuiles. Deux tuiles identiques <strong>fusionnent</strong> au contact !",
    "%disclaimer"           : "<strong class=\"important\">Note:</strong> This site <a href=\"http://git.io/cupcakes\">git.io/cupcakes</a> is a spin-off of the official version of <a href=\"http://git.io/2048\">2048</a> created by <a href=\"http://gabrielecirulli.com\" target=\"_blank\">Gabriele Cirulli</a>.",
    "%credits"              : "Images BYD",
    "%tweet1"               : "J'ai marqué \" at 2048-BYD-CARS #2048game",
    "%tile-legend"          : "<strong class=\"important\">Tuiles BYD :</strong>",

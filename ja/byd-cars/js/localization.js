...
"ja": {
    "%game-intro"           : "BYDの車を合体させて<strong>夢の一台</strong>を目指そう！",
    "%restart-button"       : "新しいゲーム",
    "%keep-playing-button"  : "続ける",
    "%retry-button"         : "もう一度",
    "%game-won"             : "クリア！",
    "%game-over"            : "ゲームオーバー！",
    "%game-explanation"     : "<strong class=\"important\">遊び方：</strong> <strong>矢印キー</strong>でタイルを動かします。同じ絵柄のタイルが触れると<strong>合体してレベルアップ</strong>します！",
    "%disclaimer"           : "<strong class=\"important\">Note:</strong> This site <a href=\"http://git.io/cupcakes\">git.io/cupcakes</a> is a spin-off of the official version of <a href=\"http://git.io/2048\">2048</a> created by <a href=\"http://gabrielecirulli.com\" target=\"_blank\">Gabriele Cirulli</a>.",
    "%credits"              : "BYD Car Images",
    "%tweet1"               : "I scored \" at 2048-BYD-CARS #2048game",
    "%tile-legend"          : "<strong class=\"important\">BYD Car Tiles:</strong>",

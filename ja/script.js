...
const games = [
    {
        ...
        icon: '🔢',
        url: 'https://2048hub.com/ja/classic-2048/', // Replace with actual game URL
        iframe: true
    },
    {
        ...
        icon: '🎤',
        url: 'https://2048hub.com/ja/taylor-swift-2048/', // Replace with actual game URL
        iframe: true
    },
    {
        id: '2048-cupcakes',
        title: '2048 カップケーキ',
        description: 'かわいいカップケーキテーマの2048',
        icon: '🧁',
        url: 'https://2048hub.com/ja/2048-cupcakes/', // Replace with actual game URL
        iframe: true
    },
    {
        id: '2048-cupcakes-christmas',
        title: '2048 クリスマスカップケーキ',
        description: 'クリスマステーマのカップケーキ2048',
        icon: '🎄',
        url: 'https://2048hub.com/ja/2048cupcakes-christmas/', // Replace with actual game URL
        iframe: true
    },
    {
        id: '2048-princess',
        title: '2048 プリンセス',
        description: 'ローズピンクテーマでプリンセスを集める2048',
        icon: '👸',
        url: 'https://2048hub.com/ja/2048-princess/',
        iframe: true,
        isNew: true
    },
    {
        ...
        icon: '🟩',
        url: 'https://2048hub.com/ja/2048-minecraft/',
        iframe: true,
        isNew: true
    },
    {
        id: 'couch-2048',
        title: 'カウチ 2048',
        description: 'リラックスできる2048',
        icon: '🛋️',
        url: 'https://2048hub.com/ja/couch-2048/', // Replace with actual game URL
        iframe: true
    },
    {
        id: 'card-2048',
        title: 'カード 2048',
        description: 'トランプの数字で遊ぶ2048',
        icon: '🃏',
        url: 'https://2048hub.com/ja/card-2048/', // Replace with actual game URL
        iframe: true
    },
    {
        id: '2048-byd-cars',
        title: '2048 BYD カーズ',
        description: 'BYD車テーマの2048',
        icon: '🚗',
        url: 'https://2048hub.com/ja/byd-cars/', // Replace with actual game URL
        iframe: true
    },
    {
        id: 'flappy-2048',
        ...
        icon: '🐦',
        url: 'https://2048hub.com/ja/flappy-2048/',
        iframe: true,
        isNew: true
    },
    {
        id: 'doge-2048',
        title: 'Doge 2048',
        description: 'ドージミームタイルの2048',
        icon: '🐶',
        url: 'https://2048hub.com/ja/doge-2048/', // Replace with actual game URL
        iframe: true
    },
    {
        id: '2048-remastered',
        title: '2048 リマスター',
        description: '高品質グラフィックの2048',
        icon: '🎮',
        url: 'https://2048hub.com/ja/2048-remastered/', // Replace with actual game URL
        iframe: true
    },
    {
        id: 'hex-2048',
        title: 'ヘックス 2048',
        description: '六角形グリッドの戦略的2048',
        icon: '⬡',
        url: 'https://2048hub.com/ja/hex-2048/', // Replace with actual game URL
        iframe: true
    }
];
        ...
        iframe.onerror = function() {
            ...
            loading.innerHTML = `
                <div style="text-align: center; color: #666; padding: 40px;">
                    ...
                    <h3 style="color: #2c3e50; margin-bottom: 15px;">ゲームの読み込みに失敗しました</h3>
                    <p style="margin-bottom: 25px; color: #7f8c8d;">サーバーに接続できません。しばらくしてからお試しください。</p>
...
function showWelcome(clearHash = true) {
    ...
    // Clear URL hash only if explicitly requested (e.g., when user clicks ホーム button)
    if (clearHash) {

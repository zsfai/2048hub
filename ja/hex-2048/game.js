...
window.onload = function() {
  ...
  function preload () {
      ...
      game.load.image('移動_instructions', '移動_example.png');
  ...
  function setUpInstructions() {
    ...
    text = game.add.text(SHIFT_X, SHIFT_Y, "Press a valid 移動 key to continue読み込み中読み込み中読み込み中読み込み中読み込み中...", style);
    text.setTextBounds(0, game.height / 2 + 200, game.width, 250);
    instructionsDisplay.add(text);
    var keys = game.add.sprite(115 + SHIFT_X, SHIFT_Y + 120, 'keys');
    var 移動_instructions = game.add.sprite(game.width / 2 - 100 + SHIFT_X, SHIFT_Y + 260, '移動_instructions');
    instructionsDisplay.add(移動_instructions);
  ...
  function create () {
    ...
    // Add 新しいゲーム button event listener
  ...
  function displayEnding() {
    ...
    style = { font: "18px upheaval", fill: "#fff", boundsAlignH: "center", textAlign: "center", wordWrap: true, wordWrapWidth: game.width - 100 };
    text = game.add.text(0, 0, "Press enter to try again読み込み中読み込み中読み込み中読み込み中読み込み中...", style);

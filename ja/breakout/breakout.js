...
Breakout = {
  ...
  Defaults: {
    ...
    サウンドs: {
      brick:    'サウンド/breakout/brick.mp3',
      paddle:   'サウンド/breakout/paddle.mp3',
      go:       'サウンド/breakout/go.mp3',
      levelup:  'サウンド/breakout/levelup.mp3',
      loselife: 'サウンド/breakout/loselife.mp3',
      gameover: 'サウンド/breakout/gameover.mp3'
    }
  ...
  initialize: function(runner, cfg) {
    ...
    this.サウンド   = (this.storage.サウンド == "true");
    ...
    Game.loadSounds({サウンドs: cfg.サウンドs});
  },
  ...
  addEvents: function() {
    ...
    Game.addEvent('サウンド', 'change', this.toggleSound.bind(this, false));
  ...
  toggleSound: function() {
    this.storage.サウンド = this.サウンド = !this.サウンド;
  },
  ...
  refreshDOM: function() {
    ...
    $('サウンド').checked = this.サウンド;
  },

  playSound: function(id) {
    if (サウンドManager && this.サウンド) {
      サウンドManager.play(id);
    }
  },

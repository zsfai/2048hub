...
const games = [
    {
        ...
        icon: '🔢',
        url: 'https://2048hub.com/it/classic-2048/', // Replace with actual game URL
        iframe: true
    },
    {
        ...
        icon: '🎤',
        url: 'https://2048hub.com/it/taylor-swift-2048/', // Replace with actual game URL
        iframe: true
    },
    {
        id: '2048-cupcakes',
        ...
        icon: '🧁',
        url: 'https://2048hub.com/it/2048-cupcakes/', // Replace with actual game URL
        iframe: true
    },
    {
        id: '2048-cupcakes-christmas',
        title: '2048 Cupcakes Natale',
        description: 'Cupcakes natalizi in 2048',
        icon: '🎄',
        url: 'https://2048hub.com/it/2048cupcakes-christmas/', // Replace with actual game URL
        iframe: true
    },
    {
        id: '2048-princess',
        ...
        icon: '👸',
        url: 'https://2048hub.com/it/2048-princess/',
        iframe: true,
        isNew: true
    },
    {
        ...
        icon: '🐱',
        url: 'https://2048hub.com/it/2048-cats/',
        iframe: true,
        isNew: true
    },
    {
        ...
        icon: '🟩',
        url: 'https://2048hub.com/it/2048-minecraft/',
        iframe: true,
        isNew: true
    },
    {
        ...
        icon: '🛋️',
        url: 'https://2048hub.com/it/couch-2048/', // Replace with actual game URL
        iframe: true
    },
    {
        id: 'card-2048',
        ...
        icon: '🃏',
        url: 'https://2048hub.com/it/card-2048/', // Replace with actual game URL
        iframe: true
    },
    {
        id: '2048-byd-cars',
        ...
        icon: '🚗',
        url: 'https://2048hub.com/it/byd-cars/', // Replace with actual game URL
        iframe: true
    },
    {
        id: 'flappy-2048',
        ...
        icon: '🐦',
        url: 'https://2048hub.com/it/flappy-2048/',
        iframe: true,
        isNew: true
    },
    {
        ...
        icon: '🐶',
        url: 'https://2048hub.com/it/doge-2048/', // Replace with actual game URL
        iframe: true
    },
    {
        id: '2048-remastered',
        ...
        icon: '🎮',
        url: 'https://2048hub.com/it/2048-remastered/', // Replace with actual game URL
        iframe: true
    },
    {
        id: 'hex-2048',
        ...
        icon: '⬡',
        url: 'https://2048hub.com/it/hex-2048/', // Replace with actual game URL
        iframe: true
    }
];
...
function renderGameList() {
    ...
    games.forEach(game => {
        ...
        const newBadge = game.isNew ? '<span class="new-badge">NUOVO</span>' : '';
        gameItem.innerHTML = `
            ${newBadge}

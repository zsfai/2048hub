...
String.toLocaleString({
    ...
    "%credits"              : "Immagini BYD",
    "%tweet1"               : "Ho segnato \" at 2048-BYD-CARS #2048game",
    "%tile-legend"          : "<strong class=\"important\">Tessere BYD:</strong>",
    '%2'                    : 'BYD Seagull',
    '%4'                    : 'BYD Dolphin',
    '%8'                    : 'BYD Yuan',
    '%16'                   : 'BYD Song',
...
"it": {
    "%game-intro"           : "Unisci le BYD e crea la tua <strong>auto dei sogni</strong>!",
    "%restart-button"       : "Nuova partida",
    "%keep-playing-button"  : "Continua",
    "%retry-button"         : "Riprova",
    "%game-won"             : "Hai vinto!",
    "%game-over"            : "Fine partita!",
    "%game-explanation"     : "<strong class=\"important\">Come giocare:</strong> Usa le <strong>frecce</strong> per spostare le tessere. Due tessere uguali <strong>si uniscono</strong> al contatto!",
    "%disclaimer"           : "<strong class=\"important\">Note:</strong> This site <a href=\"http://git.io/cupcakes\">git.io/cupcakes</a> is a spin-off of the official version of <a href=\"http://git.io/2048\">2048</a> created by <a href=\"http://gabrielecirulli.com\" target=\"_blank\">Gabriele Cirulli</a>.",
    "%credits"              : "Immagini BYD",
    "%tweet1"               : "Ho segnato \" at 2048-BYD-CARS #2048game",
    "%tile-legend"          : "<strong class=\"important\">Tessere BYD:</strong>",
